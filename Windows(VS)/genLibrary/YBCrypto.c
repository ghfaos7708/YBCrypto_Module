...
int32_t __declspec(dllexport) YBCrypto_PreSelfTest(void)
{
	int32_t ret = SUCCESS;
...
__declspec(dllexport) int32_t YBCrypto_GetState(void)
{
	int32_t state = Inner_API_GetState();
...
__declspec(dllexport) void YBCrypto_ModuleInfo(void)
{
