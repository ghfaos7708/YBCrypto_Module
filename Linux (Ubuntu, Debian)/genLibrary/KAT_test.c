...
const BlockCIipher_TV bcTestVectors[] = {
	{ARIA, ECB_MODE, {0x7A, 0xEC, 0x77, 0x5F, 0x7D, 0x4F, 0x49, 0x3F, 0x1E, 0xF0, 0x20, 0xCD, 0x7B, 0xFE, 0xBF, 0xD0}, 128, {0x15, 0x8B, 0x43, 0x00, 0x8F, 0x3F, 0x06, 0x5F, 0xB3, 0x49, 0xC4, 0xCD, 0xB6, 0x9B, 0xFC, 0xD7, 0xBD, 0x57, 0x99, 0xD1, 0x9F, 0x84, 0xD2, 0x24, 0xED, 0x06, 0x4F, 0xE8, 0x30, 0xCD, 0x8D, 0xB6}, 32, {0xDB, 0x20, 0x1B, 0x87, 0xBD, 0xC1, 0x0D, 0x61, 0x5D, 0xFC, 0x33, 0xBE, 0x4C, 0x0E, 0x75, 0xF5, 0xD0, 0x84, 0x2C, 0x33, 0x98, 0x76, 0x9D, 0x49, 0xD1, 0x8B, 0x7D, 0x65, 0x98, 0xBA, 0x03, 0x68}, 32, {
																																																																																																																																			0x00,
																																																																																																																																		}}, //! done : ARIA-128 ECB Mode

	{ARIA, ECB_MODE, {0x1E, 0xF0, 0x20, 0xCD, 0x7B, 0xFE, 0xBF, 0xD0, 0x15, 0x8B, 0x43, 0x00, 0x8F, 0x3F, 0x06, 0x5F, 0xB3, 0x49, 0xC4, 0xCD, 0xB6, 0x9B, 0xFC, 0xD7}, 192, {0xBD, 0x57, 0x99, 0xD1, 0x9F, 0x84, 0xD2, 0x24, 0xED, 0x06, 0x4F, 0xE8, 0x30, 0xCD, 0x8D, 0xB6, 0x71, 0x4C, 0x83, 0xB7, 0xFF, 0x2D, 0x86, 0x01, 0x6C, 0x43, 0x6A, 0x24, 0xD9, 0xC0, 0xEA, 0xFF}, 32, {0xDC, 0xFE, 0xD2, 0xA9, 0x85, 0x96, 0x93, 0x40, 0x67, 0x1D, 0x76, 0xC0, 0xDF, 0x76, 0x9F, 0x30, 0x91, 0x24, 0x88, 0x51, 0x80, 0xC4, 0x45, 0xA3, 0x8F, 0x1B, 0x2B, 0xF8, 0xF6, 0x29, 0xE4, 0xFB}, 32, {
																																																																																																																																															0x00,
																																																																																																																																														}}, //! done : ARIA-192 ECB Mode

	{ARIA, ECB_MODE, {0x15, 0x8B, 0x43, 0x00, 0x8F, 0x3F, 0x06, 0x5F, 0xB3, 0x49, 0xC4, 0xCD, 0xB6, 0x9B, 0xFC, 0xD7, 0xBD, 0x57, 0x99, 0xD1, 0x9F, 0x84, 0xD2, 0x24, 0xED, 0x06, 0x4F, 0xE8, 0x30, 0xCD, 0x8D, 0xB6}, 256, {0x71, 0x4C, 0x83, 0xB7, 0xFF, 0x2D, 0x86, 0x01, 0x6C, 0x43, 0x6A, 0x24, 0xD9, 0xC0, 0xEA, 0xFF, 0x73, 0xA8, 0x49, 0xD9, 0x3E, 0x85, 0x3A, 0xAD, 0x12, 0x5D, 0xFE, 0xC4, 0xE3, 0xE1, 0xCC, 0x89}, 32, {0x9E, 0x43, 0x5B, 0xAA, 0x06, 0xD1, 0x31, 0xA9, 0xB6, 0x02, 0x5A, 0xA4, 0x76, 0x56, 0x0D, 0xAA, 0x16, 0x9C, 0x69, 0xA1, 0xFB, 0xDD, 0xC2, 0x3E, 0xF4, 0xE6, 0x84, 0x0A, 0xD2, 0xBD, 0x66, 0x87}, 32, {
																																																																																																																																																											0x00,
																																																																																																																																																										}}, //! done : ARIA-256 ECB Mode

	{ARIA, CBC_MODE, {0x45, 0xE7, 0x75, 0x9A, 0x2E, 0x1A, 0x48, 0x1B, 0xFE, 0xF0, 0x33, 0x4F, 0xBE, 0xDD, 0x2C, 0x69}, 128, {0x97, 0x44, 0x61, 0xCE, 0xA6, 0x6F, 0x15, 0x54, 0x72, 0x3A, 0x69, 0x77, 0xED, 0x5C, 0x8B, 0xBC, 0x5B, 0x9B, 0x73, 0x4C, 0x10, 0x88, 0xC6, 0x49, 0x7B, 0x6A, 0xFB, 0x5E, 0x63, 0x78, 0xBC, 0x9A, 0x71, 0x4B, 0x8F, 0x7E, 0xEF, 0x92, 0xB5, 0x54, 0xCF, 0x08, 0x52, 0xC3, 0xEF, 0xA3, 0xCF, 0xA1}, 48, {0xED, 0x12, 0x4C, 0x67, 0x68, 0xFB, 0xAE, 0xDC, 0x29, 0xC6, 0x74, 0x44, 0xFE, 0x18, 0xEB, 0x5D, 0xFF, 0x44, 0x9D, 0xBB, 0xFD, 0x25, 0xFC, 0xB3, 0x9F, 0x5A, 0x1B, 0x7C, 0x8C, 0xE5, 0x61, 0x69, 0x67, 0xDD, 0x38, 0xF3, 0x0F, 0x97, 0x28, 0x11, 0xF6, 0xB7, 0xFD, 0xE1, 0xA1, 0x30, 0xA0, 0x4B}, 48, {0xA5, 0xC7, 0xCF, 0x9F, 0xE1, 0xB9, 0x49, 0x81, 0x94, 0xDB, 0x74, 0x89, 0x1C, 0xA2, 0x43, 0xF3}},
	//   //!done : ARIA-128 CBC Mode

	{ARIA, CTR_MODE, {0x45, 0xE7, 0x75, 0x9A, 0x2E, 0x1A, 0x48, 0x1B, 0xFE, 0xF0, 0x33, 0x4F, 0xBE, 0xDD, 0x2C, 0x69}, 128, {0x97, 0x44, 0x61, 0xCE, 0xA6, 0x6F, 0x15, 0x54, 0x72, 0x3A, 0x69, 0x77, 0xED, 0x5C, 0x8B, 0xBC, 0x5B, 0x9B, 0x73, 0x4C, 0x10, 0x88, 0xC6, 0x49, 0x7B, 0x6A, 0xFB, 0x5E, 0x63, 0x78, 0xBC, 0x9A, 0x71, 0x4B, 0x8F, 0x7E, 0xEF, 0x92, 0xB5, 0x54, 0xCF, 0x08, 0x52, 0xC3, 0xEF, 0xA3, 0xCF, 0xA1}, 48, {0xF0, 0x4F, 0x84, 0xFB, 0x31, 0x61, 0xC1, 0xD3, 0xF0, 0xA0, 0x33, 0xA5, 0xE1, 0x15, 0x57, 0x27, 0x23, 0xE5, 0x57, 0x35, 0x5D, 0xD0, 0x09, 0x0F, 0xC3, 0xB8, 0xB8, 0xB6, 0xC4, 0x00, 0x28, 0x85, 0x10, 0x5F, 0x54, 0x4B, 0x2A, 0x69, 0x63, 0x37, 0x33, 0x3A, 0x4B, 0xA0, 0x9E, 0xCC, 0x4B, 0x1D}, 48, {0xA5, 0xC7, 0xCF, 0x9F, 0xE1, 0xB9, 0x49, 0x81, 0x94, 0xDB, 0x74, 0x89, 0x1C, 0xA2, 0x43, 0xF3}},
...
int32_t Inner_API_BlockCipher_SelfTest()
{
	...
	for (int32_t cnt_i = 0; cnt_i < sizeof(bcTestVectors) / sizeof(BlockCIipher_TV); cnt_i++)
	{
		...
		YBCrypto_BlockCipher(&CM, bcTestVectors[cnt_i].algo, bcTestVectors[cnt_i].mode, ENCRYPT, bcTestVectors[cnt_i].masterkey, bcTestVectors[cnt_i].key_bitlen, bcTestVectors[cnt_i].plaintext, bcTestVectors[cnt_i].pt_bytelen, bcTestVectors[cnt_i].IV, ciphertext);
		if (memcmp(bcTestVectors[cnt_i].ciphertext_ct, ciphertext, bcTestVectors[cnt_i].pt_bytelen))
		{
			ret = FAIL_KATSELF_TEST;
			goto EXIT;
		}
		YBCrypto_BlockCipher_Init(&CM, bcTestVectors[cnt_i].algo, bcTestVectors[cnt_i].mode, DECRYPT, bcTestVectors[cnt_i].masterkey, bcTestVectors[cnt_i].key_bitlen, bcTestVectors[cnt_i].IV);
		YBCrypto_BlockCipher_Update(&CM, ciphertext, bcTestVectors[cnt_i].pt_bytelen, recovered, &out_bytelen);
		YBCrypto_BlockCipher_Final(&CM, recovered, &pad_bytelen);
...
static const HashFunction_TV HashTestVectors[] =
	{
		{SHA256,
		 "abc",
...
static const HMAC_TV hmactestvector[] = {
...
EXIT:
	if (ret != SUCCESS)
	{
		fprintf(stdout, "=*Location : Inner_API_HMAC_SelfTest    =\n");
	}
